 ...
 * @category Wallet SDK
 */
export function createTransaction(utxo_entry_source: IUtxoEntry[], outputs: IPaymentOutput[], priority_fee: bigint, payload?: HexString | Uint8Array | null, compute_commit?: IComputeCommit | ComputeCommit | null, version?: number | null): Transaction;
/**
...
export interface InitOutput {
  ...
  readonly computecommit_set_type: (a: number, b: number, c: number, d: number) => void;
  ...
  readonly createTransaction: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => void;
