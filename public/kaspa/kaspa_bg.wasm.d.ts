...
export const computecommit_set_type: (a: number, b: number, c: number, d: number) => void;
...
export const createTransaction: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => void;
