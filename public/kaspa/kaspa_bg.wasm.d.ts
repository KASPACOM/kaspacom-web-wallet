...
export const mnemonic_constructor: (
  a: number,
  b: number,
  c: number,
  d: number,
...
export const transactionoutput_ctor: (
  a: bigint,
  b: number,
  c: number,
) => number;
...
export const payToScriptHashSignatureScript: (
  a: number,
  b: number,
  c: number,
) => void;
...
export const covenantbinding_set_authorizingInput: (
  a: number,
  b: number,
) => void;
...
export const genesiscovenantgroup_ctor: (
  a: number,
  b: number,
  c: number,
) => void;
export const genesiscovenantgroup_outputs: (a: number) => number;
export const genesiscovenantgroup_set_authorizingInput: (
  a: number,
  b: number,
) => void;
export const genesiscovenantgroup_set_outputs: (
  a: number,
  b: number,
  c: number,
) => void;
...
export const header_get_accepted_id_merkle_root_as_hex: (
  a: number,
  b: number,
) => void;
...
export const header_set_accepted_id_merkle_root_from_js_value: (
  a: number,
  b: number,
) => void;
...
export const header_set_hash_merkle_root_from_js_value: (
  a: number,
  b: number,
) => void;
export const header_set_nonce: (a: number, b: bigint) => void;
export const header_set_parents_by_level_from_js_value: (
  a: number,
  b: number,
) => void;
export const header_set_pruning_point_from_js_value: (
  a: number,
  b: number,
) => void;
export const header_set_timestamp: (a: number, b: bigint) => void;
export const header_set_utxo_commitment_from_js_value: (
  a: number,
  b: number,
) => void;
...
export const transactioninput_get_signature_script_as_hex: (
  a: number,
  b: number,
) => void;
export const transactioninput_get_utxo: (a: number) => number;
export const transactioninput_set_compute_budget: (
  a: number,
  b: number,
) => void;
export const transactioninput_set_previous_outpoint: (
  a: number,
  b: number,
  c: number,
) => void;
...
export const transactioninput_set_signature_script_from_js_value: (
  a: number,
  b: number,
  c: number,
) => void;
...
export const __wbg_set_utxoentry_scriptPublicKey: (
  a: number,
  b: number,
) => void;
...
export const utxoentries_set_items_from_js_array: (
  a: number,
  b: number,
) => void;
...
export const __wbg_get_transactionutxoentry_blockDaaScore: (
  a: number,
) => bigint;
...
export const __wbg_get_transactionutxoentry_scriptPublicKey: (
  a: number,
) => number;
...
export const __wbg_set_transactionutxoentry_amount: (
  a: number,
  b: bigint,
) => void;
export const __wbg_set_transactionutxoentry_blockDaaScore: (
  a: number,
  b: bigint,
) => void;
export const __wbg_set_transactionutxoentry_covenantId: (
  a: number,
  b: number,
) => void;
export const __wbg_set_transactionutxoentry_isCoinbase: (
  a: number,
  b: number,
) => void;
export const __wbg_set_transactionutxoentry_scriptPublicKey: (
  a: number,
  b: number,
) => void;
export const __wbg_transactionutxoentry_free: (a: number, b: number) => void;
export const scriptpublickey_constructor: (
  a: number,
  b: number,
  c: number,
) => void;
...
export const scriptbuilder_addLockTime: (
  a: number,
  b: number,
  c: bigint,
) => void;
...
export const scriptbuilder_encodePayToScriptHashSignatureScript: (
  a: number,
  b: number,
  c: number,
) => void;
export const scriptbuilder_fromScript: (
  a: number,
  b: number,
  c: number,
) => void;
...
export const scriptbuilder_addSequence: (
  a: number,
  b: number,
  c: bigint,
) => void;
...
export const wallet_removeEventListener: (
  a: number,
  b: number,
  c: number,
  d: number,
...
export const argon2sha256ivFromText: (
  a: number,
  b: number,
  c: number,
  d: number,
) => void;
export const decryptXChaCha20Poly1305: (
  a: number,
  b: number,
  c: number,
  d: number,
...
export const encryptXChaCha20Poly1305: (
  a: number,
  b: number,
  c: number,
  d: number,
...
export const pendingtransaction_createInputSignature: (
  a: number,
  b: number,
  c: number,
  d: number,
...
export const pendingtransaction_fillInput: (
  a: number,
  b: number,
  c: number,
  d: number,
...
export const pendingtransaction_serializeToObject: (
  a: number,
  b: number,
) => void;
export const pendingtransaction_serializeToSafeJSON: (
  a: number,
  b: number,
) => void;
export const pendingtransaction_sign: (
  a: number,
  b: number,
  c: number,
  d: number,
) => void;
export const pendingtransaction_signInput: (
  a: number,
  b: number,
  c: number,
  d: number,
...
export const sompiToKaspaStringWithSuffix: (
  a: number,
  b: number,
  c: number,
) => void;
export const storage_filename: (a: number, b: number) => void;
export const utxoprocessor_addEventListener: (
  a: number,
  b: number,
  c: number,
  d: number,
...
export const utxoprocessor_removeEventListener: (
  a: number,
  b: number,
  c: number,
  d: number,
...
export const utxoprocessor_setCoinbaseTransactionMaturityDAA: (
  a: number,
  b: number,
  c: bigint,
) => void;
export const utxoprocessor_setNetworkId: (
  a: number,
  b: number,
  c: number,
) => void;
export const utxoprocessor_setUserTransactionMaturityDAA: (
  a: number,
  b: number,
  c: bigint,
) => void;
...
export const __wbg_get_transactionrecord_metadata: (
  a: number,
  b: number,
) => void;
...
export const __wbg_get_transactionrecord_unixtimeMsec: (
  a: number,
  b: number,
) => void;
export const __wbg_get_transactionrecordnotification_data: (
  a: number,
) => number;
export const __wbg_get_transactionrecordnotification_type: (
  a: number,
  b: number,
) => void;
export const __wbg_get_walletdescriptor_filename: (
  a: number,
  b: number,
) => void;
...
export const __wbg_set_transactionrecord_metadata: (
  a: number,
  b: number,
  c: number,
) => void;
export const __wbg_set_transactionrecord_network: (
  a: number,
  b: number,
) => void;
export const __wbg_set_transactionrecord_note: (
  a: number,
  b: number,
  c: number,
) => void;
export const __wbg_set_transactionrecord_unixtimeMsec: (
  a: number,
  b: number,
  c: bigint,
) => void;
export const __wbg_set_transactionrecordnotification_data: (
  a: number,
  b: number,
) => void;
export const __wbg_set_transactionrecordnotification_type: (
  a: number,
  b: number,
  c: number,
) => void;
export const __wbg_set_walletdescriptor_filename: (
  a: number,
  b: number,
  c: number,
) => void;
export const __wbg_set_walletdescriptor_title: (
  a: number,
  b: number,
  c: number,
) => void;
export const __wbg_transactionrecord_free: (a: number, b: number) => void;
export const __wbg_transactionrecordnotification_free: (
  a: number,
  b: number,
) => void;
...
export const transactionrecord_maturityProgress: (
  a: number,
  b: number,
  c: number,
) => void;
...
export const publickey_toAddressECDSA: (
  a: number,
  b: number,
  c: number,
) => void;
...
export const xonlypublickey_toAddress: (
  a: number,
  b: number,
  c: number,
) => void;
export const xonlypublickey_toAddressECDSA: (
  a: number,
  b: number,
  c: number,
) => void;
...
export const derivationpath_push: (
  a: number,
  b: number,
  c: number,
  d: number,
...
export const publickeygenerator_changeAddress: (
  a: number,
  b: number,
  c: number,
  d: number,
) => void;
export const publickeygenerator_changeAddressAsString: (
  a: number,
  b: number,
  c: number,
  d: number,
) => void;
export const publickeygenerator_changeAddressAsStrings: (
  a: number,
  b: number,
  c: number,
  d: number,
...
export const publickeygenerator_changeAddresses: (
  a: number,
  b: number,
  c: number,
  d: number,
...
export const publickeygenerator_changePubkey: (
  a: number,
  b: number,
  c: number,
) => void;
export const publickeygenerator_changePubkeyAsString: (
  a: number,
  b: number,
  c: number,
) => void;
export const publickeygenerator_changePubkeys: (
  a: number,
  b: number,
  c: number,
  d: number,
) => void;
export const publickeygenerator_changePubkeysAsStrings: (
  a: number,
  b: number,
  c: number,
  d: number,
) => void;
export const publickeygenerator_fromMasterXPrv: (
  a: number,
  b: number,
  c: number,
  d: bigint,
...
export const publickeygenerator_fromXPub: (
  a: number,
  b: number,
  c: number,
) => void;
export const publickeygenerator_receiveAddress: (
  a: number,
  b: number,
  c: number,
  d: number,
) => void;
export const publickeygenerator_receiveAddressAsString: (
  a: number,
  b: number,
  c: number,
  d: number,
) => void;
export const publickeygenerator_receiveAddressAsStrings: (
  a: number,
  b: number,
  c: number,
  d: number,
...
export const publickeygenerator_receiveAddresses: (
  a: number,
  b: number,
  c: number,
  d: number,
...
export const publickeygenerator_receivePubkey: (
  a: number,
  b: number,
  c: number,
) => void;
export const publickeygenerator_receivePubkeyAsString: (
  a: number,
  b: number,
  c: number,
) => void;
export const publickeygenerator_receivePubkeys: (
  a: number,
  b: number,
  c: number,
  d: number,
) => void;
export const publickeygenerator_receivePubkeysAsStrings: (
  a: number,
  b: number,
  c: number,
  d: number,
...
export const privatekey_toAddressECDSA: (
  a: number,
  b: number,
  c: number,
) => void;
...
export const privatekeygenerator_changeKey: (
  a: number,
  b: number,
  c: number,
) => void;
export const privatekeygenerator_new: (
  a: number,
  b: number,
  c: number,
  d: bigint,
...
export const privatekeygenerator_receiveKey: (
  a: number,
  b: number,
  c: number,
) => void;
...
export const pskt_inputAndRedeemScript: (
  a: number,
  b: number,
  c: number,
  d: number,
...
export const __wbg_set_nodedescriptor_uid: (
  a: number,
  b: number,
  c: number,
) => void;
export const __wbg_set_nodedescriptor_url: (
  a: number,
  b: number,
  c: number,
) => void;
...
export const rpcclient_addEventListener: (
  a: number,
  b: number,
  c: number,
  d: number,
...
export const rpcclient_clearEventListener: (
  a: number,
  b: number,
  c: number,
) => void;
...
export const rpcclient_estimateNetworkHashesPerSecond: (
  a: number,
  b: number,
) => number;
...
export const rpcclient_getDaaScoreTimestampEstimate: (
  a: number,
  b: number,
) => number;
export const rpcclient_getFeeEstimate: (a: number, b: number) => number;
export const rpcclient_getFeeEstimateExperimental: (
  a: number,
  b: number,
) => number;
...
export const rpcclient_getMempoolEntriesByAddresses: (
  a: number,
  b: number,
) => number;
...
export const rpcclient_getVirtualChainFromBlock: (
  a: number,
  b: number,
) => number;
export const rpcclient_getVirtualChainFromBlockV2: (
  a: number,
  b: number,
) => number;
...
export const rpcclient_parseUrl: (
  a: number,
  b: number,
  c: number,
  d: number,
...
export const rpcclient_removeEventListener: (
  a: number,
  b: number,
  c: number,
  d: number,
) => void;
export const rpcclient_resolveFinalityConflict: (
  a: number,
  b: number,
) => number;
...
export const rpcclient_submitTransactionReplacement: (
  a: number,
  b: number,
) => number;
...
export const rpcclient_subscribePruningPointUtxoSetOverride: (
  a: number,
) => number;
...
export const rpcclient_subscribeVirtualChainChanged: (
  a: number,
  b: number,
) => number;
...
export const rpcclient_unsubscribeFinalityConflictResolved: (
  a: number,
) => number;
export const rpcclient_unsubscribeNewBlockTemplate: (a: number) => number;
export const rpcclient_unsubscribePruningPointUtxoSetOverride: (
  a: number,
) => number;
export const rpcclient_unsubscribeSinkBlueScoreChanged: (a: number) => number;
export const rpcclient_unsubscribeUtxosChanged: (
  a: number,
  b: number,
) => number;
export const rpcclient_unsubscribeVirtualChainChanged: (
  a: number,
  b: number,
) => number;
...
export const __wbg_createwritestreamoptions_free: (
  a: number,
  b: number,
) => void;
...
export const createwritestreamoptions_new_with_values: (
  a: number,
  b: number,
  c: number,
  d: number,
...
export const createwritestreamoptions_set_auto_close: (
  a: number,
  b: number,
) => void;
export const createwritestreamoptions_set_emit_close: (
  a: number,
  b: number,
) => void;
export const createwritestreamoptions_set_encoding: (
  a: number,
  b: number,
) => void;
...
export const createwritestreamoptions_set_start: (
  a: number,
  b: number,
  c: number,
) => void;
...
export const formatinputpathobject_new_with_values: (
  a: number,
  b: number,
  c: number,
  d: number,
...
export const appendfileoptions_new_with_values: (
  a: number,
  b: number,
  c: number,
) => number;
...
export const assertionerroroptions_new: (
  a: number,
  b: number,
  c: number,
  d: number,
...
export const createreadstreamoptions_high_water_mark: (
  a: number,
  b: number,
) => void;
export const createreadstreamoptions_mode: (a: number) => number;
export const createreadstreamoptions_new_with_values: (
  a: number,
  b: number,
  c: number,
  d: number,
...
export const createreadstreamoptions_set_auto_close: (
  a: number,
  b: number,
) => void;
export const createreadstreamoptions_set_emit_close: (
  a: number,
  b: number,
) => void;
export const createreadstreamoptions_set_encoding: (
  a: number,
  b: number,
) => void;
export const createreadstreamoptions_set_end: (
  a: number,
  b: number,
  c: number,
) => void;
...
export const createreadstreamoptions_set_high_water_mark: (
  a: number,
  b: number,
  c: number,
) => void;
export const createreadstreamoptions_set_mode: (a: number, b: number) => void;
export const createreadstreamoptions_set_start: (
  a: number,
  b: number,
  c: number,
) => void;
...
export const getnameoptions_new: (
  a: number,
  b: number,
  c: number,
  d: number,
...
export const writestream_add_listener_with_close: (
  a: number,
  b: number,
) => number;
export const writestream_add_listener_with_open: (
  a: number,
  b: number,
) => number;
...
export const writestream_prepend_listener_with_close: (
  a: number,
  b: number,
) => number;
export const writestream_prepend_listener_with_open: (
  a: number,
  b: number,
) => number;
export const writestream_prepend_once_listener_with_close: (
  a: number,
  b: number,
) => number;
export const writestream_prepend_once_listener_with_open: (
  a: number,
  b: number,
) => number;
...
export const processsendoptions_set_swallow_errors: (
  a: number,
  b: number,
) => void;
...
export const wasioptions_new_with_values: (
  a: number,
  b: number,
  c: number,
  d: number,
...
export const netserveroptions_set_allow_half_open: (
  a: number,
  b: number,
) => void;
export const netserveroptions_set_pause_on_connect: (
  a: number,
  b: number,
) => void;
...
export const agentconstructoroptions_set_keep_alive: (
  a: number,
  b: number,
) => void;
export const agentconstructoroptions_set_keep_alive_msecs: (
  a: number,
  b: number,
) => void;
export const agentconstructoroptions_set_max_free_sockets: (
  a: number,
  b: number,
) => void;
export const agentconstructoroptions_set_max_sockets: (
  a: number,
  b: number,
) => void;
export const agentconstructoroptions_set_timeout: (
  a: number,
  b: number,
) => void;
...
export const createhookcallbacks_new: (
  a: number,
  b: number,
  c: number,
  d: number,
...
export const createhookcallbacks_set_promise_resolve: (
  a: number,
  b: number,
) => void;
...
export const streamtransformoptions_set_transform: (
  a: number,
  b: number,
) => void;
...
export const writefilesyncoptions_new: (
  a: number,
  b: number,
  c: number,
) => number;
...
export const readstream_add_listener_with_close: (
  a: number,
  b: number,
) => number;
export const readstream_add_listener_with_open: (
  a: number,
  b: number,
) => number;
...
export const readstream_prepend_listener_with_close: (
  a: number,
  b: number,
) => number;
export const readstream_prepend_listener_with_open: (
  a: number,
  b: number,
) => number;
export const readstream_prepend_once_listener_with_close: (
  a: number,
  b: number,
) => number;
export const readstream_prepend_once_listener_with_open: (
  a: number,
  b: number,
) => number;
export const __wbg_consoleconstructoroptions_free: (
  a: number,
  b: number,
) => void;
...
export const consoleconstructoroptions_new_with_values: (
  a: number,
  b: number,
  c: number,
  d: number,
...
export const consoleconstructoroptions_set_color_mod: (
  a: number,
  b: number,
) => void;
export const consoleconstructoroptions_set_ignore_errors: (
  a: number,
  b: number,
) => void;
export const consoleconstructoroptions_set_inspect_options: (
  a: number,
  b: number,
) => void;
export const consoleconstructoroptions_set_stderr: (
  a: number,
  b: number,
) => void;
export const consoleconstructoroptions_set_stdout: (
  a: number,
  b: number,
) => void;
...
export const __wbindgen_export_8: (
  a: number,
  b: number,
  c: number,
  d: number,
...
export const __wbindgen_export_11: (
  a: number,
  b: number,
  c: number,
  d: number,
...
export const __wbindgen_export_13: (
  a: number,
  b: number,
  c: number,
  d: number,
