...
export class Erc20SummaryComponent implements OnDestroy, AfterViewInit {
  ...
  tokens = computed<Erc20Token[]>(() => {
    const erc20Assets: Erc20Token[] = this.assetsManagerService
      .getAllAssetStores()
  ...
  loading = computed(
    () =>
      !this.assetsManagerService
        .getAllAssetStores()
        .l2.getAssetSignal(L2_ASSET_KEYS.erc20)(),
  );
