...
export const CONTRACT_TEMPLATES: ContractTemplate[] = [
  {
    ...
    description: 'Lock funds with your wallet as owner and a backup wallet that can recover after a chosen date.',
    icon: '🔒',
    ...
    fields: [
      {
        ...
        description: 'Your selected wallet. It can spend the vault immediately.',
      },
      {
        paramName: 'recovery',
        ...
        type: 'address',
        placeholder: 'kaspatest:q...',
        description: 'Fallback wallet that can spend after the unlock date passes.',
      },
      {
        paramName: 'timeout',
        ...
        type: 'int_timestamp',
        placeholder: '',
        description: 'The date and time when the recovery wallet becomes allowed to withdraw.',
  ...
  },
  {
    ...
    description: 'Protect funds with three signers. Any two signers can approve a withdrawal.',
    icon: '🔑',
    ...
    fields: [
      {
        ...
        type: 'address',
        placeholder: 'kaspatest:q...',
        description: 'Your selected wallet. It is the first signer in the vault quorum.',
      },
      {
        paramName: 'key2',
        ...
        type: 'address',
        placeholder: 'kaspatest:q...',
        description: 'Second wallet allowed to sign. Any two of the three signers can spend.',
      },
      {
        paramName: 'key3',
        ...
        type: 'address',
        placeholder: 'kaspatest:q...',
        description: 'Third wallet allowed to sign. Any two of the three signers can spend.',
      },
    ],
    placeholderArgs: [
  ...
  },
  {
    ...
    description: 'Buyer and seller escrow with a trusted arbiter who can resolve disputes.',
    icon: '🤝',
    ...
    fields: [
      {
        ...
        type: 'address',
        placeholder: 'kaspatest:q...',
        description: 'Your selected wallet. The buyer can approve release or refund after expiry.',
      },
      {
        paramName: 'seller',
        label: 'Seller wallet',
        type: 'address',
        placeholder: 'kaspatest:q...',
        description: 'Seller wallet that receives funds when both sides release.',
      },
      {
        ...
        type: 'hash32',
        placeholder: '0x...',
        description: 'Trusted third party for disputes. Paste an address, public key, or 32-byte hash.',
      },
      {
        paramName: 'expiry',
        ...
        type: 'int_timestamp',
        placeholder: '',
        description: 'Date and time when the buyer refund path becomes available.',
        helpUrl: 'https://www.epochconverter.com/',
      },
    ],
    placeholderArgs: [
  ...
  },
  {
    ...
    description: 'Inheritance-style covenant. Your wallet refreshes the deadline; the heir can claim if it expires.',
    icon: '⏳',
    ...
    fields: [
      {
        ...
        type: 'address',
        placeholder: 'kaspatest:q...',
        description: 'Your selected wallet. It must refresh the deadline before the heir can claim.',
      },
      {
        paramName: 'heir',
        label: 'Heir wallet',
        type: 'address',
        placeholder: 'kaspatest:q...',
        description: 'Beneficiary wallet that can claim all funds if the owner misses the deadline.',
      },
      {
        paramName: 'expiry',
        ...
        description: 'Absolute deadline. The heir can claim after this time unless the owner extends it with keepAlive.',
      },
    ],
    placeholderArgs: [
      byteArrayArg([170, 171, 172, 173, 174, 175, 176, 177, 178, 179, 180, 181, 182, 183, 184, 185, 186, 187, 188, 189, 190, 191, 192, 193, 194, 195, 196, 197, 198, 199, 200, 201]),
