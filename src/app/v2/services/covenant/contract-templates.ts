...
export const CONTRACT_TEMPLATES: ContractTemplate[] = [
  ...
  },
  {
    ...
    description: 'Inheritance contract. Owner calls keepAlive periodically to refresh the expiry. If the expiry passes without a keepAlive, the heir can claim all funds. Uses the same proven timestamp mechanism as the Time-Lock Vault.',
    icon: '⏳',
    ...
    fields: [
      {
        ...
        type: 'address',
        placeholder: 'kaspatest:q...',
        description: 'The owner must call keepAlive before expiry to keep funds locked. Each keepAlive resets the expiry. Can also reclaim funds anytime.',
      },
      {
        paramName: 'heir',
        label: 'Heir Address',
        type: 'address',
        placeholder: 'kaspatest:q...',
        description: 'If the owner fails to call keepAlive before expiry, the heir can claim all funds. Think of this as your inheritance beneficiary.',
      },
      {
        paramName: 'expiry',
